...
| [hustvl/DiffusionDrive](https://github.com/hustvl/DiffusionDrive) | 1,291 | Python | [CVPR 2025 Highlight] Truncated Diffusion Model for Real-Time End-to-E |
| [hustvl/VAD](https://github.com/hustvl/VAD) | 1,235 | Python | [ICCV 2023 & ICLR 2026] VAD: Vectorized Scene Representation for Effic |
| [ZhengYinan-AIR/Diffusion-Planner](https://github.com/ZhengYinan-AIR/Diffusion-Planner) | 872 | Python | [ICLR 2025 Oral] The official implementation of "Diffusion-Based Plann |
...
| [autonomousvision/carla_garage](https://github.com/autonomousvision/carla_garage) | 503 | Python | [ICCV'23] Hidden Biases of End-to-End Driving Models & A starter kit f |
...
| [xiaomi-research/recogdrive](https://github.com/xiaomi-research/recogdrive) | 451 | Python | [ICLR 2026] ReCogDrive: A Reinforced Cognitive Framework for End-to-En |
...
| [YvanYin/GoalFlow](https://github.com/YvanYin/GoalFlow) | 358 | Python | Repo of "GoalFlow: Goal-Driven Flow Matching for Multimodal Trajectori |
...
| [OpenDriveLab/Openpilot-Deepdive](https://github.com/OpenDriveLab/Openpilot-Deepdive) | 292 | Python | Our insights of Openpilot, a deepdive project on it |
| [adept-thu/MomAD](https://github.com/adept-thu/MomAD) | 263 | Python | [CVPR2025] Don’t Shake the Wheel: Momentum-Aware Planning in End-to-En |
...
| [GuanxingLu/vlarl](https://github.com/GuanxingLu/vlarl) | 401 | Python | Single-file implementation to advance vision-language-action (VLA) mod |
...
| [RenzKa/simlingo](https://github.com/RenzKa/simlingo) | 359 | Python | [CVPR 2025, Spotlight] SimLingo (CarLLava): Vision-Only Closed-Loop Au |
| [phospho-app/phosphobot](https://github.com/phospho-app/phosphobot) | 351 | Python | Control AI robots. Community-driven UI middleware for controlling robo |
...
| [PKU-EPIC/GraspVLA](https://github.com/PKU-EPIC/GraspVLA) | 341 | Python | [CoRL25] GraspVLA: a Grasping Foundation Model Pre-trained on Billion- |
| [PKU-HMI-Lab/Hybrid-VLA](https://github.com/PKU-HMI-Lab/Hybrid-VLA) | 338 | Python | HybridVLA: Collaborative Diffusion and Autoregression in a Unified Vis |
| [cccedric/conrft](https://github.com/cccedric/conrft) | 328 | Python | This is the official implementation of the paper "ConRFT: A Reinforced |
...
| [nv-tlabs/Cosmos-Drive-Dreams](https://github.com/nv-tlabs/Cosmos-Drive-Dreams) | 427 | Jupyter Notebook | Cosmos-Drive-Dreams: Scalable Synthetic Driving Data Generation with W |
...
| [SenseTime-FVG/OpenDWM](https://github.com/SenseTime-FVG/OpenDWM) | 370 | Python | An open source code repository of driving world models, with training, |
...
| [xinge008/Cylinder3D](https://github.com/xinge008/Cylinder3D) | 939 | Python | Rank 1st in the leaderboard of SemanticKITTI semantic segmentation (bo |
...
| [Sense-GVT/Fast-BEV](https://github.com/Sense-GVT/Fast-BEV) | 784 | Python | Fast-BEV: A Fast and Strong Bird’s-Eye View Perception Baseline |
...
| [wzzheng/TPVFormer](https://github.com/wzzheng/TPVFormer) | 1,329 | Python | [CVPR 2023] An academic alternative to Tesla's occupancy network for a |
...
| [weiyithu/SurroundOcc](https://github.com/weiyithu/SurroundOcc) | 1,010 | Python | [ICCV 2023] SurroundOcc: Multi-camera 3D Occupancy Prediction for Auto |
...
| [HuaiyuanXu/3D-Occupancy-Perception](https://github.com/HuaiyuanXu/3D-Occupancy-Perception) | 579 | - | [Information Fusion 2025] A Survey on Occupancy Perception for Autonom |
...
| [huang-yh/SelfOcc](https://github.com/huang-yh/SelfOcc) | 380 | Python | [CVPR 2024] SelfOcc: Self-Supervised Vision-Based 3D Occupancy Predict |
...
| [libai1943/CartesianPlanner](https://github.com/libai1943/CartesianPlanner) | 337 | C++ | Source codes of “Autonomous Driving on Curvy Roads without Reliance on |
...
| [gaoxiang12/slam_in_autonomous_driving](https://github.com/gaoxiang12/slam_in_autonomous_driving) | 2,446 | C++ | 《自动驾驶中的SLAM技术》对应开源代码 |
...
| [MRPT/mrpt](https://github.com/MRPT/mrpt) | 2,112 | C++ | :zap: The Mobile Robot Programming Toolkit (MRPT) |
...
| [w111liang222/lidar-slam-detection](https://github.com/w111liang222/lidar-slam-detection) | 716 | C++ | LSD (LiDAR SLAM & Detection) is an open source perception architecture |
...
| [eclipse-sumo/sumo](https://github.com/eclipse-sumo/sumo) | 3,897 | C++ | Eclipse SUMO is an open source, highly portable, microscopic and conti |
...
| [motional/nuplan-devkit](https://github.com/motional/nuplan-devkit) | 965 | Python | The devkit of the nuPlan dataset. |
...
| [autonomousvision/navsim](https://github.com/autonomousvision/navsim) | 884 | Python | [CoRL '25] Pseudo-Simulation for Autonomous Driving; [NeurIPS '24] NAV |
...
| [autorope/donkeycar](https://github.com/autorope/donkeycar) | 3,376 | Python | Open source hardware and software platform to build a small scale self |
...
| [flowdriveai/flowpilot](https://github.com/flowdriveai/flowpilot) | 2,006 | C | flow-pilot is an openpilot based driver assistance system that runs on |
| [sunnypilot/sunnypilot](https://github.com/sunnypilot/sunnypilot) | 1,824 | Python | sunnypilot is an open source driver assistance system. sunnypilot offe |
...
| [usdot-fhwa-OPS/V2X-Hub](https://github.com/usdot-fhwa-OPS/V2X-Hub) | 136 | C++ | V2X Hub is a message handler that acts as a translator and data aggreg |
...
| [PJLab-ADG/SensorsCalibration](https://github.com/PJLab-ADG/SensorsCalibration) | 3,036 | C++ | OpenCalib: A Multi-sensor Calibration Toolbox for Autonomous Driving |
