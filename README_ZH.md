...
| [hustvl/DiffusionDrive](https://github.com/hustvl/DiffusionDrive) | 1,291 | Python | [CVPR 2025突出] 短缩的扩散模型用于实时端到端自动驾驶 |
| [hustvl/VAD](https://github.com/hustvl/VAD) | 1,235 | Python | [ICCV 2023 & ICLR 2026] VAD:为有效自动驾驶的矢量化场景表示 |
| [ZhengYinan-AIR/Diffusion-Planner](https://github.com/ZhengYinan-AIR/Diffusion-Planner) | 872 | Python | [ICLR 2025 口头]"灵活指导自动驾驶基于分散的规划"正式实施 |
| [swc-17/SparseDrive](https://github.com/swc-17/SparseDrive) | 870 | Python | 通过Sparse场景表示,SparseDrive:端到端自动驾驶 |
| [opendilab/LMDrive](https://github.com/opendilab/LMDrive) | 866 | Jupyter Notebook | [CVPR 2024] LMDrive:使用大型语言模型的闭环端到端驾驶 |
| [wvangansbeke/LaneDetection_End2End](https://github.com/wvangansbeke/LaneDetection_End2End) | 665 | Python | 自动驾驶汽车端到端路检测 (ICCV 2019 研讨会) |
| [datvuthanh/HybridNets](https://github.com/datvuthanh/HybridNets) | 664 | Python | 混合网络:端到端感知网络 |
| [xiaomi-mlab/Orion](https://github.com/xiaomi-mlab/Orion) | 586 | Python | [ICCV 2025] "ORION:视觉语言指导行动生成的整体端到端自动驾驶框架"官方代码 |
| [hustvl/Senna](https://github.com/hustvl/Senna) | 530 | Python | 跨越大型视觉语言模型和自动驾驶端到端 |
| [experiencor/self-driving-toy-car](https://github.com/experiencor/self-driving-toy-car) | 520 | Jupyter Notebook | 无人驾驶玩具车使用端到端学习 |
| [autonomousvision/carla_garage](https://github.com/autonomousvision/carla_garage) | 503 | Python | [ICCV'23] 终端驾驶模型的隐藏偏见和CARLA排名榜2.0的启动套件 |
| [opendilab/awesome-end-to-end-autonomous-driving](https://github.com/opendilab/awesome-end-to-end-autonomous-driving) | 489 | - | 无限自动驾驶资源的整理列表 (不断更新) |
| [wzzheng/GenAD](https://github.com/wzzheng/GenAD) | 475 | Python | [ECCV 2024] GenAD:生成端到端自动驾驶 |
| [chauvinSimon/My_Bibliography_for_Research_on_Autonomous_Driving](https://github.com/chauvinSimon/My_Bibliography_for_Research_on_Autonomous_Driving) | 464 | - | 关于"自动驾驶决策"的科学和研究工作的个人笔记 |
| [xiaomi-research/recogdrive](https://github.com/xiaomi-research/recogdrive) | 451 | Python | [ICLR 2026] 雷科格驱动:终端自动驾驶的增强认知框架 |
| [dotchen/LAV](https://github.com/dotchen/LAV) | 441 | Python | 简单的,无地图的,自动驾驶的终端到终端堆,用于共同的感知,预测,规划和控制. |
| [OpenDriveLab/ST-P3](https://github.com/OpenDriveLab/ST-P3) | 424 | Python | [ECCV 2022]ST-P3,通过空间及时间特征学习,基于端到端视觉的自动驾驶框架. |
| [zhejz/carla-roach](https://github.com/zhejz/carla-roach) | 387 | Python | 罗奇:通过模仿强化学习教练进行终端城市驾驶. |
| [YvanYin/GoalFlow](https://github.com/YvanYin/GoalFlow) | 358 | Python | 关于"目标流:目标驱动的流量匹配,用于自动驾驶端到端的多模式轨迹生成"的回复 |
| [dotchen/LearningByCheating](https://github.com/dotchen/LearningByCheating) | 334 | Python | (CoRL 2019) 使用路线预测和两阶段模仿学习在CARLA驾驶 |
| [autonomousvision/neat](https://github.com/autonomousvision/neat) | 327 | Python | [ICCV'21] NEAT:自动驾驶端到端的神经注意力场 |
| [ucd-dare/CarDreamer](https://github.com/ucd-dare/CarDreamer) | 320 | Python | 基于世界模型的自动驾驶平台在卡拉:汽车: |
| [BraveGroup/LAW](https://github.com/BraveGroup/LAW) | 317 | Python | 通过拉登世界模式提高自动驾驶的终端 |
| [cjy1992/interp-e2e-driving](https://github.com/cjy1992/interp-e2e-driving) | 293 | Python | 具有潜伏深度强化学习的可解释端到端城市自动驾驶 |
| [OpenDriveLab/Openpilot-Deepdive](https://github.com/OpenDriveLab/Openpilot-Deepdive) | 292 | Python | 我们对Openpilot的见解, |
| [adept-thu/MomAD](https://github.com/adept-thu/MomAD) | 263 | Python | [CVPR2025] 不要动动车:自动驾驶的终端计划 |
| [jmwang0117/HE-Drive](https://github.com/jmwang0117/HE-Drive) | 253 | Python | 视觉语言模型的端到端驾驶 |
...
| [GuanxingLu/vlarl](https://github.com/GuanxingLu/vlarl) | 401 | Python | 单档实现以加强学习为基础推进视觉语言行动 (VLA) 模型. |
| [InternRobotics/InternVLA-M1](https://github.com/InternRobotics/InternVLA-M1) | 377 | Python | 国际机器人技术:一个空间导向的视觉语言行动框架 |
| [RenzKa/simlingo](https://github.com/RenzKa/simlingo) | 359 | Python | [CVPR 2025,焦点]SimLingo (CarLLava):仅视觉闭环自动驾驶,语言行动配合 |
| [phospho-app/phosphobot](https://github.com/phospho-app/phosphobot) | 351 | Python | 控制人工智能机器人. 控制机器人,记录数据集,训练行动模型的社区驱动 UI中间件. 与SO-100和SO-101兼容 |
...
| [PKU-EPIC/GraspVLA](https://github.com/PKU-EPIC/GraspVLA) | 341 | Python | [CoRL25] GraspVLA:基于数十亿美元的合成行动数据预先训练的Graping基础模型 |
| [PKU-HMI-Lab/Hybrid-VLA](https://github.com/PKU-HMI-Lab/Hybrid-VLA) | 338 | Python | 混合VLA:在统一视觉语言行动模式中协同传播和自动降低 |
| [cccedric/conrft](https://github.com/cccedric/conrft) | 328 | Python | 这就是"ConRFT:通过一致性政策"论文的正式实施. |
...
| [JeffWang987/DriveDreamer](https://github.com/JeffWang987/DriveDreamer) | 544 | Python | [ECCV 2024] 驱动梦想:向自动驾驶的现实世界驱动型号 |
| [nnanhuang/S3Gaussian](https://github.com/nnanhuang/S3Gaussian) | 522 | Python | 官方实施自主驾驶的街道高斯人 |
| [HaoranZhuExplorer/World-Models-Autonomous-Driving-Survey](https://github.com/HaoranZhuExplorer/World-Models-Autonomous-Driving-Survey) | 489 | - | 专用驾驶汽车的全球模型. |
| [JOP-Lee/READ](https://github.com/JOP-Lee/READ) | 452 | Python | 通过"READ:大规模神经场景转化自动驾驶"的实施,实验结果比基于NERF的方法显著好. |
| [nv-tlabs/Cosmos-Drive-Dreams](https://github.com/nv-tlabs/Cosmos-Drive-Dreams) | 427 | Jupyter Notebook | 随着世界基金会模型的可扩展合成驾驶数据生成 |
| [yifanlu0227/ChatSim](https://github.com/yifanlu0227/ChatSim) | 418 | Python | [CVPR2024突出]通过LLM-代理合作可编辑的自动驾驶场景模拟 |
| [BraveGroup/Drive-WM](https://github.com/BraveGroup/Drive-WM) | 411 | Python | [CVPR 2024] 无人驾驶的世界模式. |
| [SenseTime-FVG/OpenDWM](https://github.com/SenseTime-FVG/OpenDWM) | 370 | Python | 开源代码库,包括训练,推断,评估工具和预训练的检查站. |
| [LinShan-Bin/OccNeRF](https://github.com/LinShan-Bin/OccNeRF) | 357 | Python | 标签: "OccNeRF:在无LIDAR环境中推进3D占用率预测". |
| [OpenDriveLab/ViDAR](https://github.com/OpenDriveLab/ViDAR) | 346 | Python | [CVPR 2024 突出]视觉点云预测 |
| [carlinds/splatad](https://github.com/carlinds/splatad) | 344 | Cuda | 实时Lidar和摄像头呈现,可用于自动驾驶的3D高斯式喷 |
...
| [Anttwo/MACARONS](https://github.com/Anttwo/MACARONS) | 83 | Jupyter Notebook | 马卡龙的官方代码:RGB ONLINE自监督的地图和覆盖预测.还包含了我们之前的工作SCONE (NeurIPS 2022) 的更新和改进实... |
| [ai4ce/MARS](https://github.com/ai4ce/MARS) | 60 | Python | 无线电系统: 开放的MARS数据集 |
| [yuantianyuan01/PreSight](https://github.com/yuantianyuan01/PreSight) | 45 | Python | 预视的官方代码基础:通过城市规模的NeRF优先级提高自动驾驶汽车的感知 |
| [muyishen2040/DriveEnvNeRF](https://github.com/muyishen2040/DriveEnvNeRF) | 39 | JavaScript | [ICRA 2024 研讨会] 驱动动器-NeRF:探索基于NeRF的自动驾驶环境,以验证现实世界性能 |
| [GigaAI-research/DriveDreamer](https://github.com/GigaAI-research/DriveDreamer) | 38 | Python | [ECCV 2024] 驱动梦想:向自动驾驶的现实世界驱动型号 |
...
| [ethz-asl/lidar_align](https://github.com/ethz-asl/lidar_align) | 1,015 | C++ | 找出3D雷达和6dof姿势传感器之间的外部校准的简单方法 |
| [mileyan/pseudo_lidar](https://github.com/mileyan/pseudo_lidar) | 1,001 | Jupyter Notebook | (CVPR 2019) 视觉深度估计:为自动驾驶实现3D对象检测的差距 |
| [xinge008/Cylinder3D](https://github.com/xinge008/Cylinder3D) | 939 | Python | 排名第1的语义KITTI语义分类排名榜 (单次扫描和多次扫描) (2020年11月) (CVPR2021口头) |
| [url-kaist/patchwork-plusplus](https://github.com/url-kaist/patchwork-plusplus) | 929 | C++ | 补丁工程++:用于3DLiDAR扫描的快速而强大的地面分区方法. @IROS'22 |
| [tusen-ai/SST](https://github.com/tusen-ai/SST) | 873 | Python | 编码用于一系列在LiDAR感知中的工作,包括SST (CVPR 22),FSD (NeurIPS 22),FSD++ (TPAMI 23),... |
| [koide3/ndt_omp](https://github.com/koide3/ndt_omp) | 829 | C++ | 多线程和SSE友好的NDT算法 |
| [zhulf0804/PointPillars](https://github.com/zhulf0804/PointPillars) | 819 | Python | 简单的点柱 PyTorch 实现3D LiDAR (KITTI) 检测. |
| [walzimmer/3d-bat](https://github.com/walzimmer/3d-bat) | 800 | TypeScript | 3D 边界框注释工具 (3D-BAT) 点云和图像标签 |
| [pengsongyou/openscene](https://github.com/pengsongyou/openscene) | 799 | Python | 开放场景:使用开放词汇理解3D场景 |
| [NVlabs/FB-BEV](https://github.com/NVlabs/FB-BEV) | 784 | Python | 官方PyTorch实施FB-BEV和FB-OCC - 视觉前向向转换以视觉为中心的自动驾驶感知 |
| [Sense-GVT/Fast-BEV](https://github.com/Sense-GVT/Fast-BEV) | 784 | Python | 快速BEV:快速强的鸟眼视觉感知基准 |
| [lorenwel/linefit_ground_segmentation](https://github.com/lorenwel/linefit_ground_segmentation) | 784 | C++ | 由于这些数据的数据, |
| [ika-rwth-aachen/Cam2BEV](https://github.com/ika-rwth-aachen/Cam2BEV) | 779 | Python | 基于多辆车载摄像头的图像,计算一个语义细分的鸟眼图像 (BEV) 的TensorFlow实现. |
| [lzccccc/SMOKE](https://github.com/lzccccc/SMOKE) | 775 | Python | 烟雾:单阶段单光3D物体检测通过关键点估计 |
...
| [ndrplz/self-driving-car](https://github.com/ndrplz/self-driving-car) | 2,908 | C++ | 乌达市自动驾驶汽车工程师纳米学位项目. |
| [MaybeShewill-CV/lanenet-lane-detection](https://github.com/MaybeShewill-CV/lanenet-lane-detection) | 2,533 | Python | 实时行道检测的lanenet模型的非官方实施 |
| [hustvl/YOLOP](https://github.com/hustvl/YOLOP) | 2,170 | Python | 只有一次才会看到全身驾驶感知. |
...
| [cfzd/Ultra-Fast-Lane-Detection](https://github.com/cfzd/Ultra-Fast-Lane-Detection) | 2,013 | Python | 超快结构意识深轨检测 (ECCV 2020) |
| [wzzheng/TPVFormer](https://github.com/wzzheng/TPVFormer) | 1,329 | Python | 作为特斯拉自动驾驶的自动驾驶网络的学术替代品. |
| [cardwing/Codes-for-Lane-Detection](https://github.com/cardwing/Codes-for-Lane-Detection) | 1,066 | Lua | 通过自觉注意精学习轻量级车道检测CNN (ICCV 2019) |
| [weiyithu/SurroundOcc](https://github.com/weiyithu/SurroundOcc) | 1,010 | Python | [ICCV 2023] 环绕Occ:多摄像头3D占用率预测自动驾驶 |
| [voldemortX/pytorch-auto-drive](https://github.com/voldemortX/pytorch-auto-drive) | 940 | Python | PytorchAutoDrive:基于PyTorch的分类模型 (ERFNet,ENet,DeepLab,FCN...) 和路线检测模型 (... |
| [CVPR2023-3D-Occupancy-Prediction/CVPR2023-3D-Occupancy-Prediction](https://github.com/CVPR2023-3D-Occupancy-Prediction/CVPR2023-3D-Occupancy-Prediction) | 866 | Python | 预测和预测的挑战 |
| [fregu856/deeplabv3](https://github.com/fregu856/deeplabv3) | 816 | Python | 基于CityScapes数据集训练的DeepLabV3的PyTorch实现. |
| [astra-vision/MonoScene](https://github.com/astra-vision/MonoScene) | 798 | Python | [CVPR 2022] "单场景:单场景3D语义场景完成":单个图像的3D语义占用率预测 |
| [cfzd/Ultra-Fast-Lane-Detection-v2](https://github.com/cfzd/Ultra-Fast-Lane-Detection-v2) | 790 | Python | 超快深轨检测,混合坐标定位分类 (TPAMI 2022) |
| [Charmve/OccNet-Course](https://github.com/Charmve/OccNet-Course) | 745 | Python | 国内首个占据格网络全课程从BEV到占用网络,算法原理与工程实践,包含端侧部署。自动驾驶的周围语义占用感知课程 (doc, ppt和源码) 在... |
| [lucastabelini/LaneATT](https://github.com/lucastabelini/LaneATT) | 693 | Python | 标题: 保持道路的注意力:实时注意力指导的道路检测 |
| [vasgaowei/BEV-Perception](https://github.com/vasgaowei/BEV-Perception) | 692 | - | 鸟眼的视觉 |
| [huang-yh/GaussianFormer](https://github.com/huang-yh/GaussianFormer) | 637 | Python | [ECCV 2024] 视觉基于3D语义占用预测的高西人场景 |
| [Turoad/lanedet](https://github.com/Turoad/lanedet) | 618 | Python | 基于PyTorch的开源路径检测工具箱,包括SCNN,RESA,UFLD,LaneATT,CondLane等. |
| [HuaiyuanXu/3D-Occupancy-Perception](https://github.com/HuaiyuanXu/3D-Occupancy-Perception) | 579 | - | [信息融合2025]自动驾驶的职业感知调查:信息融合的前景 |
| [OpenDriveLab/OpenLane](https://github.com/OpenDriveLab/OpenLane) | 567 | C++ | [ECCV 2022 口头] 开放线:大规模的现实3D线数据集 |
| [SeokjuLee/VPGNet](https://github.com/SeokjuLee/VPGNet) | 503 | Jupyter Notebook | 路线和道路标记检测和识别的消失点指导网络 (ICCV 2017) |
...
| [huang-yh/SelfOcc](https://github.com/huang-yh/SelfOcc) | 380 | Python | [CVPR 2024] 自主监督:基于视觉的3D占用预测 |
| [AngeLouCN/CFPNet](https://github.com/AngeLouCN/CFPNet) | 345 | Python | 基于火的自动驾驶实时分区模型 |
| [HanXinzi-AI/awesome-computer-vision-resources](https://github.com/HanXinzi-AI/awesome-computer-vision-resources) | 336 | - | 计算机视觉方向项目和工具集合── |
| [bamwani/car-counting-and-speed-estimation-yolo-sort-python](https://github.com/bamwani/car-counting-and-speed-estimation-yolo-sort-python) | 322 | Python | 该项目实现了以下项目的任务: 1.车辆计数, 2.车道检测, 3.车道变化检测和 4.速度估计 |
| [jason-li-831202/Vehicle-CV-ADAS](https://github.com/jason-li-831202/Vehicle-CV-ADAS) | 272 | Python | 该项目可以仅使用视觉传感器实现FCWS,LDWS和LKAS功能.使用YOLOv5 /YOLOv5-lite /YOLOv6 /YOLOv7 ... |
| [zya3d/Awesome-3D-Occupancy-Prediction](https://github.com/zya3d/Awesome-3D-Occupancy-Prediction) | 263 | - | 基于视觉的3D自动驾驶占用率预测:审查和前景 |
| [haomo-ai/Cam4DOcc](https://github.com/haomo-ai/Cam4DOcc) | 262 | Python | [CVPR 2024]Cam4DOcc:仅为摄像头使用的4D占用率预测标准 |
...
| 项目 | ⭐ | 语言 | 描述 |
|------|---:|:----:|------|
| [opf/openproject](https://github.com/opf/openproject) | 14,508 | Ruby | 开放项目是领先的开源项目管理软件. |
...
| [StanfordASL/Trajectron-plus-plus](https://github.com/StanfordASL/Trajectron-plus-plus) | 789 | Jupyter Notebook | 附加于TIM SALZMANN*,BORIS IWANOVIC*,PUNARJEY CHACRAVARTY和MARCO PAVONE的202... |
...
| [Fields2Cover/Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) | 759 | C++ | 独立农车的可靠和高效覆盖路径. |
| [ZikangZhou/QCNet](https://github.com/ZikangZhou/QCNet) | 753 | Python | 预测时间: |
| [ZikangZhou/HiVT](https://github.com/ZikangZhou/HiVT) | 709 | Python | [CVPR 2022] HiVT:多代理运动预测的层次向量变压器 |
| [autonomousvision/tuplan_garage](https://github.com/autonomousvision/tuplan_garage) | 691 | Python | [CoRL'23] 关于基于学习的车辆运动规划的误解 |
| [MizuhoAOKI/python_simple_mppi](https://github.com/MizuhoAOKI/python_simple_mppi) | 677 | Jupyter Notebook |  Python 实现MPPI (模型预测路径整体) 控制器来理解基本概念.强制性依赖性仅是 numpy 和 matplotlib. |
| [LiJiangnanBit/path_optimizer](https://github.com/LiJiangnanBit/path_optimizer) | 590 | C++ | 基于优化的实时路径规划. |
| [jchengai/pluto](https://github.com/jchengai/pluto) | 568 | Python | 普鲁托:推进基于模仿学习的自动驾驶计划的极限 |
| [leggedrobotics/se2_navigation](https://github.com/leggedrobotics/se2_navigation) | 557 | C++ | 纯粹的追求控制和SE(2) 规划 |
| [uber-research/LaneGCN](https://github.com/uber-research/LaneGCN) | 546 | Python | [ECCV2020口头]学习轨道图表表,用于运动预测 |
| [DeepTecher/AutonomousVehiclePaper](https://github.com/DeepTecher/AutonomousVehiclePaper) | 494 | - | 无人驾驶相关论文速递 |
| [Habrador/Self-driving-vehicle](https://github.com/Habrador/Self-driving-vehicle) | 454 | C# | 模拟自动驾驶汽车路径规划. 这也是混合A*路径查找算法的实施,如果您对汽车路径查找感兴趣,则很有用. |
| [stepankonev/waymo-motion-prediction-challenge-2022-multipath-plus-plus](https://github.com/stepankonev/waymo-motion-prediction-challenge-2022-multipath-plus-plus) | 412 | Python | 解决Waymo运动预测挑战2022年. 我们实施多路径++ |
| [Pandas-Team/Automatic-Parking](https://github.com/Pandas-Team/Automatic-Parking) | 388 | Python | 通过Python实现虚拟环境中自动平行停车系统,包括路径规划,路径跟踪和平行停车 |
| [UW-ACL/SCPToolbox.jl](https://github.com/UW-ACL/SCPToolbox.jl) | 345 | Julia | 顺序曲线编程工具箱用于非曲线轨迹优化. |
| [libai1943/CartesianPlanner](https://github.com/libai1943/CartesianPlanner) | 337 | C++ | 无需依赖网框架的自动驾驶:基于卡特西亚的轨道规划方法的源代码发表在IEEE Trans.智能运输系统 |
| [leggedrobotics/xpp](https://github.com/leggedrobotics/xpp) | 337 | C++ | 视觉化为脚踏机器人的动作 |
| [MCZhi/GameFormer](https://github.com/MCZhi/GameFormer) | 336 | Python | [ICCV 2023 口头]基于变压器的互动预测和规划的游戏理论建模和学习 |
| [matssteinweg/Multi-Purpose-MPC](https://github.com/matssteinweg/Multi-Purpose-MPC) | 334 | Python | 参考路径跟踪,最佳时间驾驶和避免障碍的多用途MPC |
| [hustvl/AlphaDrive](https://github.com/hustvl/AlphaDrive) | 318 | Python | 通过加强学习和推理,释放自动驾驶VLM的力量 |
| [Liang-ZX/VectorNet](https://github.com/Liang-ZX/VectorNet) | 290 | Jupyter Notebook | 向量网:从向量化表示中编码高清地图和代理动态 |
| [MCZhi/DIPP](https://github.com/MCZhi/DIPP) | 281 | Python | 城市自动驾驶的可区别的综合预测和规划框架 |
| [sigmaai/self-driving-golf-cart](https://github.com/sigmaai/self-driving-golf-cart) | 263 | C++ | 让自己被驱动 |
...
| [cartographer-project/cartographer](https://github.com/cartographer-project/cartographer) | 7,787 | C++ | 图形绘制器是一个系统,可在多个平台和传感器配置中提供2D和3D的实时同时定位和映射 (SLAM). |
| [cvg/Hierarchical-Localization](https://github.com/cvg/Hierarchical-Localization) | 3,967 | Python | 视觉定位化通过Hloc实现了轻松的 |
...
| [ethz-asl/maplab](https://github.com/ethz-asl/maplab) | 2,817 | C++ | 模块化和多模块化地图框架 |
| [tum-vision/lsd_slam](https://github.com/tum-vision/lsd_slam) | 2,702 | C++ | 液化剂 |
| [RobustFieldAutonomyLab/LeGO-LOAM](https://github.com/RobustFieldAutonomyLab/LeGO-LOAM) | 2,694 | C++ | 雷戈-洛姆:轻量化和地形优化的Lidar眼科测量和变量地形地图 |
| [gaoxiang12/slam_in_autonomous_driving](https://github.com/gaoxiang12/slam_in_autonomous_driving) | 2,446 | C++ | 自动驾驶中的SLAM技术对应开源代码 |
| [SteveMacenski/slam_toolbox](https://github.com/SteveMacenski/slam_toolbox) | 2,351 | C++ | 随着ROS的使用,可能具有巨大地图的终身映射和定位的Slam工具箱 |
| [OctoMap/octomap](https://github.com/OctoMap/octomap) | 2,267 | C++ | 基于Octrees的高效概率3D映射框架.包含主要的OctoMap库,视频视频视频视频视频视频视频视频视频视频视频视频视频视频视频视频视频视... |
| [MRPT/mrpt](https://github.com/MRPT/mrpt) | 2,112 | C++ | :zap:移动机器人编程工具包 (MRPT) |
| [cra-ros-pkg/robot_localization](https://github.com/cra-ros-pkg/robot_localization) | 1,816 | C++ | 机器人_定位化是一个非线性状态估计节点的包.该包是由查尔斯河分析公司开发的.请在 answers.ros.org 询问问题. |
...
| [w111liang222/lidar-slam-detection](https://github.com/w111liang222/lidar-slam-detection) | 716 | C++ | 液压 (LSD) 是一个开源的自动驾驶汽车/机器人感知架构 |
| [jwchoi384/Gaussian_YOLOv3](https://github.com/jwchoi384/Gaussian_YOLOv3) | 669 | C | 盖斯YOLOv3:使用自动驾驶定位不确定性的精确和快速物体探测器 (ICCV, 2019) |
| [liuguitao/AVP-SLAM-PLUS](https://github.com/liuguitao/AVP-SLAM-PLUS) | 668 | C++ | 实施AVP-SLAM和一些新贡献 |
...
| [exodus4d/pathfinder](https://github.com/exodus4d/pathfinder) | 402 | JavaScript | 为了EVE ONLINE的地图化工具 |
...
| [eclipse-sumo/sumo](https://github.com/eclipse-sumo/sumo) | 3,897 | C++ | lipse SUMO是一个开源,高度便携式,显微型和连续的交通模拟包,旨在处理大型网络.它允许包括行人在内的互动模拟,并配备了大量的场景创建... |
...
| [traveller59/second.pytorch](https://github.com/traveller59/second.pytorch) | 1,782 | Python | 对于KITTI/NuScenes对象检测的第二个 |
...
| [streamlit/demo-self-driving](https://github.com/streamlit/demo-self-driving) | 1,279 | Python | 通过YOLO显示一个图像浏览器的Streamlit应用程序,用于Udacity自动驾驶汽车数据集,并可实时检测物体. |
...
| [hanruihua/ir-sim](https://github.com/hanruihua/ir-sim) | 1,022 | Python | 基于Python的轻量级机器人模拟器,用于导航,控制和学习 |
| [LucasAlegre/sumo-rl](https://github.com/LucasAlegre/sumo-rl) | 992 | Python | 加强与SUMO的交通信号控制学习环境.与体育馆,PettingZoo和受欢迎的RL图书馆兼容. |
| [motional/nuplan-devkit](https://github.com/motional/nuplan-devkit) | 965 | Python | 现在,我们需要一个新的数据库. |
| [StanfordVL/GibsonEnv](https://github.com/StanfordVL/GibsonEnv) | 934 | C | 吉布森环境:实世界对身体代理人的感知 |
| [deepdrive/deepdrive](https://github.com/deepdrive/deepdrive) | 926 | Python | 动器是一个模拟器,允许任何拥有PC的人在自动驾驶中推进最先进的技术. |
| [argoverse/argoverse-api](https://github.com/argoverse/argoverse-api) | 925 | Python | 官方GitHub存储库用于Argoverse数据集 |
| [argoai/argoverse-api](https://github.com/argoverse/argoverse-api) | 925 | Python | 官方GitHub存储库用于Argoverse数据集 |
| [MarvinTeichmann/KittiSeg](https://github.com/MarvinTeichmann/KittiSeg) | 920 | Python | 在 tensorflow 中实施的基蒂路分区模型. |
| [Amin-Tgz/awesome-CARLA](https://github.com/Amin-Tgz/awesome-CARLA) | 907 | - | 👉 CARLA资源如教程,博客,代码等 |
| [taco-group/OpenEMMA](https://github.com/taco-group/OpenEMMA) | 899 | Python | 开放EMMA,是Waymo的开源模型的许可许可的"复制". |
| [DeepTecher/awesome-autonomous-vehicle](https://github.com/DeepTecher/awesome-autonomous-vehicle) | 899 | - | 无人驾驶的资源列表中文版 |
| [autonomousvision/navsim](https://github.com/autonomousvision/navsim) | 884 | Python | [CoRL '25] 自动驾驶伪模拟; [NeurIPS '24] NAVSIM:数据驱动的非反应自动驾驶车辆模拟和基准测量 |
...
| [onqtam/doctest](https://github.com/doctest/doctest) | 6,627 | C++ | 最快的功能丰富的C++11/14/17/20/23单头测试框架 |
| [danmar/cppcheck](https://github.com/danmar/cppcheck) | 6,519 | C++ | 基于C/C++代码的静态分析 |
...
| [autorope/donkeycar](https://github.com/autorope/donkeycar) | 3,376 | Python | 开源硬件和软件平台,以建造小型自动驾驶汽车. |
...
| [flowdriveai/flowpilot](https://github.com/flowdriveai/flowpilot) | 2,006 | C | 流动飞行器是一个基于Openpilot的驾驶员辅助系统,运行在Linux,Windows和Android驱动机上. |
| [sunnypilot/sunnypilot](https://github.com/sunnypilot/sunnypilot) | 1,824 | Python | 飞机是一个开源驾驶辅助系统. sunnypilot为用户提供了超过350个支持的汽车品牌和模型的独特驾驶体验,其操作方式是改进的. sunn... |
| [CANopenNode/CANopenNode](https://github.com/CANopenNode/CANopenNode) | 1,817 | C | 开启协议堆 |
| [allenai/ai2thor](https://github.com/allenai/ai2thor) | 1,668 | C# | 视觉人工智能的开源平台. |
| [leggedrobotics/ros_best_practices](https://github.com/leggedrobotics/ros_best_practices) | 1,632 | C++ | 适用于ROS的最佳实践,公约和技巧 |
...
| [bimmerconnected/bimmer_connected](https://github.com/bimmerconnected/bimmer_connected) | 473 | Python |  图书馆查询您的BMW或Mini的状态,从连接驱动器门户 |
| [DerrickXuNu/v2x-vit](https://github.com/DerrickXuNu/v2x-vit) | 338 | Python | [ECCV2022] 官方实施"V2X-ViT:视觉变压器的车辆到一切合作感知"论文 |
| [DerrickXuNu/CoBEVT](https://github.com/DerrickXuNu/CoBEVT) | 256 | Python | 鱼眼镜协作 语义分类与鱼变压器 |
...
| [DurgNomis-drol/ha_toyota](https://github.com/DurgNomis-drol/ha_toyota) | 171 | Python | 家庭助理丰田连接服务集成 |
| [ylwhxht/V2X-R](https://github.com/ylwhxht/V2X-R) | 148 | Python | CVPR 2025 - V2X-R:合作式LiDAR-4D雷达融合,用于3D物体检测与除散 |
| [usdot-fhwa-OPS/V2X-Hub](https://github.com/usdot-fhwa-OPS/V2X-Hub) | 136 | C++ | V2X Hub是一个信息处理器,它作为连接车辆部署的基础设施组件的翻译和数据集成/传播器. |
| [widewing/ha-toyota-na](https://github.com/widewing/ha-toyota-na) | 134 | Python | 东北美丰田汽车 (北美) 连接服务的首页助理集成 |
| [Marksman007577/Autonomous-Drive](https://github.com/Marksman007577/Autonomous-Drive) | 125 | MATLAB | 使用 MATLAB 和 Simulink 实现自动驾驶车辆建模 |
| [pytoyoda/ha_toyota](https://github.com/pytoyoda/ha_toyota) | 114 | Python | 丰田连接服务欧洲集成家庭助理. |
...
| [eclipse-mosaic/mosaic](https://github.com/eclipse-mosaic/mosaic) | 111 | Java | 食MOSAIC是一个自动化和连接移动场景的多域和多尺度模拟框架. |
| [msepulcre/C-V2X](https://github.com/msepulcre/C-V2X) | 104 | MATLAB | 分析模型 C-V2X模式4车辆通信的性能 |
| [ali322/v2x](https://github.com/ali322/v2x) | 92 | Dart | 另一个v2ex 滑动应用程序 |
| [aws-solutions/aws-connected-vehicle-solution](https://github.com/aws-solutions/aws-connected-vehicle-solution) | 91 | JavaScript |  AWS 连接车辆解决方案是一个参考实现,为连接车辆服务,自动驾驶,电动动动力以及共享移动汽车产品转型提供基础. |
| [Guojyjy/CoTV](https://github.com/Guojyjy/CoTV) | 84 | Python | 通过深度增强学习进行交通灯信号和连接自动驾驶汽车的合作控制 |
| [FabianEckermann/ns-3_c-v2x](https://github.com/FabianEckermann/ns-3_c-v2x) | 83 | C++ | 移动车辆到一切 (C-V2X) 模式4型号 ns-3 |
| [M-Parvini/AoI-V2X-IEEE-TVT-2023](https://github.com/M-Parvini/AoI-V2X-IEEE-TVT-2023) | 80 | Python | 关于通过多代理多任务增强学习为团队基于C-V2X网络的AoI-Aware资源分配的论文代码 |
...
| [taco-group/LangCoop](https://github.com/taco-group/LangCoop) | 77 | Python | 官方实施"兰克库普:与自然语言合作驾驶" |
| [thi-ad/UrbanIng-V2X](https://github.com/thi-ad/UrbanIng-V2X) | 74 | Jupyter Notebook | 城市Ing-V2X:一个大型多车辆,多基础设施数据集跨越多个交叉口,用于合作感知 |
| [eddyhkchiu/DMSTrack](https://github.com/eddyhkchiu/DMSTrack) | 74 | Python | [ICRA2024] 论文"通过可区分多传感器卡尔曼过器实现自动驾驶的3D多对象合作追踪"官方代码 |
| [josephkamel/F2MD](https://github.com/josephkamel/F2MD) | 73 | Python | 关于CITS中行为不良检测框架 (ITS-G5 & C-V2X) |
| [xuanxuanblingbling/cv2x](https://github.com/xuanxuanblingbling/cv2x) | 66 | Python | 毕业设计 C-V2X漏洞挖掘 开放资源 |
| [open-v2x/docs](https://github.com/open-v2x/docs) | 64 | Shell | 开放V2X文件 |
| [GENIVI/rvi_core](https://github.com/GENIVI/rvi_core) | 64 | Erlang | 规范,设计,规划和构建将下一代连接车辆服务驱动的开源基础设施的参考实施. |
| [jfpastrana/802.11p](https://github.com/jfpastrana/802.11p) | 63 | C | 商业Wi-Fi卡上的802.11p标准和V2X应用 |
| [liuboer/MOSEK-ADMM](https://github.com/liuboer/MOSEK-ADMM) | 63 | MATLAB | 通过标记交叉路口实现连接燃料电池混合动力电动汽车的生态驾驶的双级曲优化代码 |
...
| 项目 | ⭐ | 语言 | 描述 |
|------|---:|:----:|------|
| [syncthing/syncthing](https://github.com/syncthing/syncthing) | 80,416 | Go | 开源连续文件同步 |
| [PJLab-ADG/SensorsCalibration](https://github.com/PJLab-ADG/SensorsCalibration) | 3,036 | C++ | 开放Calib:自动驾驶多传感器校准工具箱 |
| [ankitdhall/lidar_camera_calibration](https://github.com/ankitdhall/lidar_camera_calibration) | 1,716 | C++ | 通过3D-3D点相应度进行"LiDAR-相机校准"的相机和LiDAR之间寻找硬体转换的ROS包 |
| [IFL-CAMP/easy_handeye](https://github.com/IFL-CAMP/easy_handeye) | 1,115 | Python | 无硬件独立的自动化手眼校准 |
| [dyfcalid/CameraCalibration](https://github.com/dyfcalid/CameraCalibration) | 838 | Python | 镜或正常摄像头内在和外在校准. |
| [heethesh/lidar_camera_calibration](https://github.com/heethesh/lidar_camera_calibration) | 657 | Python | 轻型摄像头使用OpenCV和PCL (PnP+LM优化) 的 ROS LiDAR校准包 |
| [wayveai/fiery](https://github.com/wayveai/fiery) | 607 | Python | 关于"FIERY:未来实例分区在周围单光相机的鸟眼中"的论文的PyTorch代码 |
| [georgesung/advanced_lane_detection](https://github.com/georgesung/advanced_lane_detection) | 559 | Python | 使用计算机视觉进行先进的行车路检测 |
| [kyegomez/RT-2](https://github.com/kyegomez/RT-2) | 551 | Python | 民主化RT-2"RT-2:新模式将视觉和语言转化为行动" |
| [tudelft-iv/multi_sensor_calibration](https://github.com/tudelft-iv/multi_sensor_calibration) | 541 | C++ |  |
| [kaist-avelab/K-Radar](https://github.com/kaist-avelab/K-Radar) | 527 | Python | 在各种天气条件下自动驾驶的4D雷达物体检测 |
...
| [brandesjj/centerfusionpp](https://github.com/brandesjj/centerfusionpp) | 73 | Python |  CenterFusion++ 是一个基于螺的相机和雷达传感器融合网络. |
| [HuangCongQing/multi-sensor-fusion](https://github.com/HuangCongQing/multi-sensor-fusion) | 71 | HTML | 多传感器融合 (同一个雷达摄像头) |
| [akhilesh-k/Lane-and-Vehicles-Detection](https://github.com/akhilesh-k/Lane-and-Vehicles-Detection) | 69 | Jupyter Notebook | 该库包含了基于Python的计算机视觉软件管道的作品,用于在视频中识别车道和车辆.该项目不是Udacity SDCND的一部分,但基于Uda... |
| [TimKie/YOLO-LiDAR-Fusion](https://github.com/TimKie/YOLO-LiDAR-Fusion) | 68 | Python | 对于自动驾驶系统的3D对象检测而言,LiDAR-摄像头融合 |
| [synsin0/SRCN3D](https://github.com/synsin0/SRCN3D) | 55 | Python | 官方实施SRCN3D:Sparse R-CNN 3D环视摄像头 3D对象检测和跟踪自动驾驶 |
| [Ayanzadeh93/Udacity-Advance-Lane-detection-of-the-road](https://github.com/Ayanzadeh93/Udacity-Advance-Lane-detection-of-the-road) | 54 | Python | 乌达西自动驾驶汽车工程师纳诺度级高级路线检测项目.使用边缘检测 (Sobel操作员,大小和方向梯度,以及HLS颜色空间),摄像头校准和解 (... |
| [uranus4ever/Advanced-Lane-Detection](https://github.com/uranus4ever/Advanced-Lane-Detection) | 54 | Python | 摄像头校准;扭曲纠正;视角转换 ("鸟眼视图");计算曲率和车辆位置. |
...
| 项目 | ⭐ | 语言 | 描述 |
|------|---:|:----:|------|
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | 159,977 | - | 掌握命令行,在一个页面 |
| [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 117,736 | TypeScript | 虚拟白板,用于绘制手绘图像图表 |
| [jesseduffield/lazygit](https://github.com/jesseduffield/lazygit) | 73,253 | Go | 简单的终端UI用于 git命令 |
| [protocolbuffers/protobuf](https://github.com/protocolbuffers/protobuf) | 70,768 | C++ | 协议缓冲器 - Google 的数据交换格式 |
| [obsproject/obs-studio](https://github.com/obsproject/obs-studio) | 70,633 | C | 欧博斯工作室 - 免费的开源软件,用于直播和屏幕录音 |
| [sharkdp/bat](https://github.com/sharkdp/bat) | 57,436 | Rust | 一只猫 (1) 有翅膀的克隆. |
| [jgm/pandoc](https://github.com/jgm/pandoc) | 42,306 | Haskell | 统一标记转换器 |
| [ray-project/ray](https://github.com/ray-project/ray) | 41,529 | Python | 雷是一个人工智能计算引擎.雷由一个分布式运行时间核心和一组用于加速ML工作负载的人工智能图书馆组成. |
| [koalaman/shellcheck](https://github.com/koalaman/shellcheck) | 39,043 | Haskell | 选,一个静态分析工具 |
| [jbarlow83/OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF) | 32,790 | Python | 通过 OCRmyPDF 添加一个 OCR 文字层,可以扫描到的 PDF 文件,从而允许搜索它们 |
| [lutzroeder/Netron](https://github.com/lutzroeder/netron) | 32,502 | JavaScript | 对于神经网络,深度学习和机器学习模型的可视化器 |
| [gabime/spdlog](https://github.com/gabime/spdlog) | 28,399 | C++ | 快速的C++记录库. |
| [fastai/fastai](https://github.com/fastai/fastai) | 27,875 | Jupyter Notebook | 佛斯塔伊深度学习图书馆 |
| [ggreer/the_silver_searcher](https://github.com/ggreer/the_silver_searcher) | 27,225 | C | 类似于Ack的代码搜索工具,但更快. |
| [samuelcolvin/pydantic](https://github.com/pydantic/pydantic) | 27,055 | Python | 使用Python类型提示的数据验证 |
...
| [iovisor/bcc](https://github.com/iovisor/bcc) | 22,253 | C | 基于BPF的Linux IO分析,网络化,监测等工具 |
| [mkdocs/mkdocs](https://github.com/mkdocs/mkdocs) | 21,801 | Python | 项目文件与马克唐. |
| [bokeh/bokeh](https://github.com/bokeh/bokeh) | 20,361 | TypeScript | 浏览器中的互动数据可视化,从Python |
| [antonmedv/fx](https://github.com/antonmedv/fx) | 20,305 | Go | 终端 JSON 浏览器和处理器 |
| [rlabbe/Kalman-and-Bayesian-Filters-in-Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) | 18,777 | Jupyter Notebook | 卡尔曼过器使用Jupyter笔记本. 专注于建立直觉和经验,而不是正式证明. 包括卡尔曼过器,扩展卡尔曼过器,无香气卡尔曼过器,颗粒过器等.... |
| [fail2ban/fail2ban](https://github.com/fail2ban/fail2ban) | 17,071 | Python | 禁止多个身份验证错误的主机 |
| [foambubble/foam](https://github.com/foambubble/foam) | 16,930 | TypeScript | 个人知识管理和共享系统 |
| [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) | 15,475 | - | 机器学习工具包 |
| [iterative/dvc](https://github.com/treeverse/dvc) | 15,404 | Python | 数据版本和ML实验 |
| [wolfpld/tracy](https://github.com/wolfpld/tracy) | 15,347 | C++ | 框架配置文件 |
| [davisking/dlib](https://github.com/davisking/dlib) | 14,356 | C++ | 一套用于C++中实体机器学习和数据分析应用的工具包 |
| [dask/dask](https://github.com/dask/dask) | 13,752 | Python | 与任务规划的平行计算 |
| [novnc/noVNC](https://github.com/novnc/noVNC) | 13,477 | JavaScript | 网络应用程序 |
| [jonas/tig](https://github.com/jonas/tig) | 13,125 | C | 语文模式接口 |
| [keplergl/kepler.gl](https://github.com/keplergl/kepler.gl) | 11,600 | TypeScript | 开普勒.gl是一个强大的开源地质空间分析工具,用于大规模数据集. |
| [cupy/cupy](https://github.com/cupy/cupy) | 10,811 | Python | 对于GPU的NumPy & SciPy |
| [EpistasisLab/tpot](https://github.com/EpistasisLab/tpot) | 10,047 | Jupyter Notebook | 通过基因编程优化机器学习管道的Python自动机器学习工具. |
| [evolus/pencil](https://github.com/evolus/pencil) | 9,586 | JavaScript | 笔项目的独特使命是建立一个免费的开源工具, |
| [rapidsai/cudf](https://github.com/rapidsai/cudf) | 9,501 | C++ | 图库 - 图库数据框架 |
| [hediet/vscode-drawio](https://github.com/hediet/vscode-drawio) | 9,403 | TypeScript | 这种非官方扩展将Draw.io (也称为 diagrams.net) 集成到VS Code中. |
| [nasa-jpl/open-source-rover](https://github.com/nasa-jpl/open-source-rover) | 9,192 | Prolog | 基于火星上的探险器的自制6轮探险器! |
| [rastapasta/mapscii](https://github.com/rastapasta/mapscii) | 8,987 | JavaScript | MapSCII是您的控制台的盲字和ASCII世界地图染器 - enter => telnet mapscii.me <=在Mac上 (装 t... |
| [openscad/openscad](https://github.com/openscad/openscad) | 8,938 | C++ | 开放SCAD - 程序员固体3DCAD模型器 |
